...
Ammo().then((Ammo) => {
  ...
  function loadFloydText() {
    ...
    text_loader.load('./src/jsm/YouSheBiaoTiHei_Regular.json', function (font) {
      var xMid, text;
      ...
      var geometry = new THREE.TextGeometry('Pavel', {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/YouSheBiaoTiHei_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('web开发工程师', {
        font: font,
        size: 2,
        height: 0.5,
        curveSegments: 20,
  ...
  function start() {
    ...
    createBillboard(-10, 2.5, -78, billboardTextures.homeSweetHomeTexture, URL.githubHomeSweetHome, Math.PI * 0.17);

    createBillboard(25, 2.5, -78, billboardTextures.meetingSystemTexture, URL.githubHomeSweetHome, Math.PI * 0.15);
    ...
    createTextOnPlane(-14, 0.01, -48, inputText.homeSweetHomeText, 20, 40);
    createTextOnPlane(20, 0.01, -48, inputText.meetingSystemText, 20, 40);
    ...
    simpleText(-42, 0.01, -30, '项目经验', 3);
    simpleText(61, 0.01, -15, '工作履历', 3);
